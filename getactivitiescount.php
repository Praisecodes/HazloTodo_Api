...
use Firebase\JWT\Key;
    ...
    $theJwtarr = explode(" ", $headers['Authorization']);
    $skey = 'some_crazy_ _secret_key_I_used';

    if(true){
        echo json_encode($theJwtarr[1]);
        //$decode = JWT::decode($theJwtarr[1], new Key($skey, 'HS256'));
